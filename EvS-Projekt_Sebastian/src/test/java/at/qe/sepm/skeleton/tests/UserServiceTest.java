...
public class UserServiceTest {
    ...
    public void testDatainitialization() {
        ...
        for (User user : userService.getAllUsers()) {
            if ("admin".equals(user.getUsername())) {
                ...
                Assert.assertTrue("User \"user1\" does not have role PSLEADER", user.getRoles().contains(UserRole.PSLEADER));
    ...
    public void testCreateUser() {
        ...
        toBeCreatedUser.setRoles(Sets.newSet(UserRole.STUDENT, UserRole.PSLEADER));
        ...
        Assert.assertTrue("User \"newuser\" does not have role PSLEADER", freshlyCreatedUser.getRoles().contains(UserRole.PSLEADER));
