...
public class TaskHandler
{
	...
	{
		pickListViewParents.setCurrentUsernames(pickListViewParents.getUsernames());
	...
	{
		Collection<User> parentsWithoutTask = new HashSet<User>(userRepository.findByRole(UserRole.PARENT));
		parentsWithoutTask.removeAll(parentsWithTask());
		return parentsWithoutTask;
	}

	public Collection<User> parentsWithTask()
	{
		return userRepository.findParentsWithTask(UserRole.PARENT);
	}
