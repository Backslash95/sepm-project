 ...
 *
 * @param <T>
 *            The domain type this repository manages.
 * @param <ID>
 *            The type of the id of the entity this repository manages.
 */
@NoRepositoryBean
public interface AbstractRepository<T, ID extends Serializable> extends Repository<T, ID>
{
	 ...
	 *             If the given entity is (@literal null}.
	 */
	 ...
	 *
	 * @param <S>
	 *            The actual domain type if the entity.
	 * @param entity
