...
public class UserServiceTest {
	...
	public void testDatainitialization() {
		...
		for (User user : userService.getAllUsers()) {
			if ("admin".equals(user.getUsername())) {
				...
				Assert.assertTrue("User \"user1\" does not have role MANAGER",
						user.getRoles().contains(UserRole.INACTIVEPARENT));
	...
	public void testCreateUser() {
		...
		toBeCreatedUser.setPassword(encoder.encode("passwd"));
		...
		toBeCreatedUser.setRoles(Sets.newSet(UserRole.EMPLOYEE, UserRole.INACTIVEPARENT));
		...
		Assert.assertEquals("User \"newuser\" does not have a the correct phone attribute stored being saved",
				"+12 345 67890", freshlyCreatedUser.getPhone());
		Assert.assertTrue("User \"newuser\" does not have role MANAGER",
				freshlyCreatedUser.getRoles().contains(UserRole.INACTIVEPARENT));
